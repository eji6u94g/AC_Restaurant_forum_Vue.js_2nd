...
export default {
  ...
  methods: {
    fetchUser(userId) {
      console.log(userId);
      this.profile.id = dummyData.profile.id;
      this.profile.name = dummyData.profile.name;
      this.profile.email = dummyData.profile.email;
      this.profile.isAdmin = dummyData.profile.isAdmin;
      this.profile.image = dummyData.profile.image;
      this.profile.Comments = dummyData.profile.Comments;
      this.profile.FavoritedRestaurants =
        dummyData.profile.FavoritedRestaurants;
